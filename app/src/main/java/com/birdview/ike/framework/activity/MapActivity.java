package com.birdview.ike.framework.activity;
...
import com.birdview.ike.framework.adapter.LocationRecyclerViewAdapter;
import com.birdview.ike.framework.model.IndividualLocation;
import com.birdview.ike.framework.util.LinearLayoutManagerWithSmoothScroller;
...
/*
 TODO Change style of the map to resemble the wireframes
 TODO Filter button to be added on the map
 TODO Test Code on actual locations with surrounding mock GeoJSON data collected from MapBox Studio
 TODO Merge codes from other team members and do unit test
 TODO Test final codes on lower apis
*/

/**
 * Activity with a Mapbox map and recyclerview to view various locations
 * with mock location hard-coded
 */
public class MapActivity extends AppCompatActivity implements
        PermissionsListener, LocationRecyclerViewAdapter.ClickListener, MapboxMap.OnMapClickListener {
...
//                    @Override
//                    public void onStyleLoaded(@NonNull Style style) {
//                          //Location Component for prompting user location permission
//                      enableLocationComponent(style);
//                    }
//                });
//    }
