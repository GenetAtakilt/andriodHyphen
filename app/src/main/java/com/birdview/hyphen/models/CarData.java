...
public class CarData {
    ...
    public CarData(int icon, int toicon, int imgclr, int imgcmr, int iconclr, int iconcar, int calender, String fromLoc, String toLoc, String calendertxt, String size,
