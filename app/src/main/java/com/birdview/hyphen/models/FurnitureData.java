...
public class FurnitureData {
    ...
    public FurnitureData(String fromLoc, String toLoc, String calaendertxt, String size, String price, int calender, int icon, int toIcon, int progress, int progressp) {
