 ...
 */
public class LocationRecyclerViewAdapter1 extends
        RecyclerView.Adapter<LocationRecyclerViewAdapter1.ViewHolder> {
    ...
    public LocationRecyclerViewAdapter1(List<IndividualLocation> styles,
