...
public class FlightSearchAdapter extends RecyclerView.Adapter<FlightSearchAdapter.FlightSearchViewHolder>{
    ...
    private List<FlightSearchData> flightSearches;

    public FlightSearchAdapter(Context mCtx, List<FlightSearchData> flightSearches) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(@NonNull FlightSearchViewHolder holder, int position) {
        ...
        FlightSearchData flightSearch = flightSearches.get(position);
